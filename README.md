...
```bash
npx @simonja/pg-mcp-readonly "postgresql://user:password@localhost:5432/mydb"
```

Or install globally:

```bash
npm install -g @simonja/pg-mcp-readonly
pg-mcp-readonly "postgresql://user:password@localhost:5432/mydb"
```
...
```bash
claude mcp add postgres -- npx @simonja/pg-mcp-readonly "postgresql://user:password@localhost:5432/mydb"
```
